...
pub fn hunks_differ_in_diff3(
    ...
    let tokens_for_hunk = |hunk: &Hunk| -> &[Token] {
...
pub fn write_ancestor(input: &InternedInput<&[u8]>, from: u32, to: usize, out: &mut Vec<u8>) {
    if to < from as usize {
        return;
    }
